<script lang="ts">
	...
	async function handleSubmit(e: any) {
		try {
			...
			const { data, error } = await supabase.from('users').update(form).eq('id', form.id);
...
<div class="container">
	...
	{:else}
		...
		>
			<ImageInput bind:files={profileFiles} {currentImageValue} bind:this={uploadedBtnInstance} />
